  ...
  head: () => ({
    meta: [
      { title: "Recall5 AI — Master any subject in 5 minutes" },
      {
        name: "description",
        content:
          "Turn dense study notes, PDFs and handwritten pages into a 5-minute revision pack with concepts, formulas, rapid-fire Q&A and exam predictions.",
      },
...
const features = [
  {
    icon: Sparkles,
    title: "5-min summaries",
    desc: "Distill an entire chapter into a sharp, exam-ready brief.",
  },
  {
    icon: Lightbulb,
    title: "Key concepts",
    desc: "Auto-extracted definitions you actually need to remember.",
  },
  {
    icon: Sigma,
    title: "Formula sheet",
    desc: "Every equation, derivation and unit on one screen.",
  },
  { icon: Zap, title: "Rapid-fire Q&A", desc: "Active recall drills tuned to spaced repetition." },
  {
    icon: GraduationCap,
    title: "Exam predictions",
    desc: "Likely questions modelled from past patterns.",
  },
  {
    icon: Upload,
    title: "Multimodal upload",
    desc: "PDFs, slides, handwritten notes — drop them in.",
  },
];
    ...
    <div className="min-h-screen relative noise-overlay aurora-bg">
          ...
          <nav className="hidden md:flex items-center gap-7 text-sm text-muted-foreground">
            {["features", "how", "stats"].map((id) => (
              <a
                key={id}
                href={`#${id}`}
                className="nav-link hover:text-foreground transition capitalize"
              >
      ...
      <section ref={heroRef} className="relative pt-28 md:pt-36 pb-28">
        ...
        >
          ...
          >
            Recall5 AI turns your messy notes, PDFs and handwritten pages into a premium revision
            pack — concepts, formulas, rapid-fire Q&amp;A and exam predictions. Calm, focused, fast.
          </motion.p>
          ...
          >
            ...
            <div className="flex items-center gap-2 px-3 pb-2">
              ...
              <span className="ml-3 text-[10px] text-muted-foreground/50 tracking-wider">
                recall5.ai/dashboard
              </span>
            </div>
            <div className="rounded-2xl bg-black/25 p-6 grid md:grid-cols-3 gap-4">
              {[
                ...
                >
                  ...
                  <div
                    className={`mt-2 text-3xl font-display font-bold bg-gradient-to-br ${s.c} bg-clip-text text-transparent stat-glow`}
                  >
                    {s.v}
                  </div>
                </motion.div>
              ...
              >
                <div className="flex items-center gap-2 text-[11px] text-muted-foreground">
                  ...
                  <span className="ml-auto px-2 py-0.5 rounded-full text-[9px] bg-accent/15 text-accent border border-accent/25">
                    Just generated
                  </span>
                </div>
                <div className="mt-2 font-display text-foreground">
                  Faraday's law and Lenz's law summary
                </div>
                <div className="mt-1 text-sm text-muted-foreground line-clamp-2">
                  EMF induced equals the negative rate of change of magnetic flux. Direction opposes
                  change…
                </div>
              </motion.div>
            </div>
      ...
      <section id="how" className="max-w-6xl mx-auto px-4 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-4 relative">
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, oklch(0.68 0.24 295 / 0.5), oklch(0.78 0.16 210 / 0.5), transparent)",
            }}
          />
          {steps.map((s, i) => (
            <motion.div
        ...
        >
          ...
          <div className="grid md:grid-cols-4 gap-6 text-center">
            {[
              ...
              >
                <div className="text-4xl md:text-5xl font-display font-bold gradient-text stat-glow">
                  {s.v}
                </div>
      ...
      <section className="max-w-4xl mx-auto px-4 py-28 text-center">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-display font-bold">
            Stop re-reading.
            <br />
            <span className="gradient-text">Start recalling.</span>
          </h2>
          ...
          <div className="mt-10">
            <Link to="/dashboard/generate">
              <GlowButton size="lg">
                <Sparkles className="w-4 h-4" /> Try Recall5 AI free
              </GlowButton>
            </Link>
          </div>
        </motion.div>
